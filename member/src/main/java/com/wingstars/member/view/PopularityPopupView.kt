...
class PopularityPopupView(var activity: Activity, var onPopupConfirm: OnPopupConfirm, var navigationBarHeight:Int) {
    private lateinit var popupWindow: PopupWindow
    private lateinit var binding: PopupPopularityViewBinding

    init { initView(activity) }
    ...
    private fun initView(mContext: Context) {
        ...
        popupWindow = PopupWindow(binding.root, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT,true)
       setNavigationBar(binding.item,navigationBarHeight,mContext,color= R.color.white)
        ...
        binding.rankList.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL,false)
