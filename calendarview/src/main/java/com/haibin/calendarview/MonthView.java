...
public abstract class MonthView extends BaseMonthView {
    ...
    private void draw(Canvas canvas, Calendar calendar, int i, int j, int d) {
        ...
        if (hasScheme) {
            ...
            if (calendar.getSchedulings() != null)
                onDrawScheduling(canvas, calendar, x, y, hasScheme, isSelected);
        } else {
            if (isSelected) {
    ...
    protected abstract void onDrawScheduling(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected);
}
