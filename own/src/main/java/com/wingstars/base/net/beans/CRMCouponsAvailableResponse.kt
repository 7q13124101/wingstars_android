...
data class CRMCouponsAvailableResponse(
    val id: String,                 //coupon id
    val couponStartDate: String,    //上架时间
    ...
    val couponStatus: Int,          //0:未上架，1：已上架，2：已下架，3：已过期
...
//        }
    ...
    val claimedCountF: Int      //claimedCount format
        get() {
...
/*
    {
            ...
            "updatedAt": "2025-05-06T10:43:48.651874+08:00",
