...
//            }
            ...
            val overlayVisibility = if (isSoldOut) View.VISIBLE else View.GONE

            binding.ivMaskImage.visibility = overlayVisibility
            binding.tvExchangeCompleted.visibility = overlayVisibility
